...
Persistent memory: `/Users/wso2/projects/ballerina/ballerina-go/ballerina-lang-go/ls/.pi/learnings/LEARNINGS-ls-ref.md` (absolute path — it lives outside this checkout).
...
- It is the only file you may write; the PoC module stays read-only.
