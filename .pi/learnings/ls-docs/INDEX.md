...
- [tickets.md](tickets.md) — backlog dependency chain and per-ticket findings (status, Java oracle contexts, decisions) for tickets 18, 20/21, 22; ticket 15 and 17 are noted only as the open frontier, with no dedicated section.
